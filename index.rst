...
-  Fixed plugin handling object group hierarchy changed events even
   while app is playing.
...
-  Fixed error which would show up when attempting to drop prefab onto
   the Prefab Library Db Window, in empty space (i.e. mouse not hovering
   library item).

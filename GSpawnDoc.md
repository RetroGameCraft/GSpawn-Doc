...
![](coffin_skeleton_decor_rules.png)
...
- Implemented [Decor Rules](##Decor Rules) that can be used in conjunction with the **Props Spawn** tool to speed up scene decoration.
